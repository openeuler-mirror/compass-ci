...
The Compass-CI client has been installed. For details, see [Installing the Local Compass-CI Client](https://atomgit.com/openeuler/compass-ci/blob/master/doc/user-guide/install-cci-client.md).
