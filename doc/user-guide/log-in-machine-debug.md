...
# 1. 前提条件：
## 请先学习:
* [配置个人邮箱](https://atomgit.com/openeuler/compass-ci/blob/master/doc/user-guide/apply-account.md)
* [如何申请测试机](https://atomgit.com/openeuler/compass-ci/blob/master/doc/user-guide/borrow-machine.zh.md)
