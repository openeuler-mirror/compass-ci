...
class Sched
  ...
  def get_job_info(job)
    ...
    job_info["custom_repo_name"] = "aarch64-budding-openeuler"
    job_info["custom_repo_addr"] = "https://api.compass-ci.openeuler.org:20012/rpm/pub/openeuler-20.03-LTS-SP1/budding-openeuler/\\$basearch/"
    job_info
  end
