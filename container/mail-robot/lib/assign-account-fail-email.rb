...
def email_err_message(message)
  ...
  when 'NOT_REGISTERED'
    err_message = <<~EMAIL_MESSAGE
      ...
      Reference the following url to learn how to register the repo:
          ...
          https://atomgit.com/openeuler/compass-ci/blob/master/doc/test-guide/test-oss-project.en.md
    EMAIL_MESSAGE
  ...
  err_message += <<~EMAIL_MESSAGE
    ...
    Manual for how to apply account:
        ...
        https://atomgit.com/openeuler/compass-ci/blob/master/doc/user-guide/apply-account.md
  EMAIL_MESSAGE
